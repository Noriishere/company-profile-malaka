<div class="min-h-screen ml-0 lg:ml-64 px-4 sm:px-6 lg:px-8 pt-20 lg:pt-10 space-y-8">
    ...
    <div>
        <h1 class="text-2xl font-semibold text-gray-800">Edit Data</h1>
        <p class="text-sm text-gray-500"><?= htmlspecialchars($filename) ?></p>
    </div>
        ...
        <form method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="jabatan"
                       value="<?= htmlspecialchars($member['jabatan']) ?>"
                       class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-biru outline-none transition">
            </div>
            ...
            <div>
                ...
                <input type="text" name="foto"
                       value="<?= htmlspecialchars($member['foto']) ?>"
                       class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-biru outline-none transition">
            </div>

            <div>
                <label class="block text-sm text-gray-600 mb-2">Ultah</label>
                <input type="text" name="ultah"
                       value="<?= htmlspecialchars($member['ultah']) ?>"
                       class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-biru outline-none transition">
            </div>
