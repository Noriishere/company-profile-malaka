<main class="w-full bg-white min-h-screen font-poppins text-slate-800">
    ...
    <section class="pt-16 pb-10 text-center">
        <div class="container mx-auto px-4">
            <h4 class="text-primary font-bold tracking-[0.2em] uppercase text-xs mb-3">HUBUNGI KAMI</h4>
            <h1 class="text-3xl md:text-5xl font-extrabold text-slate-900 mb-4">
                Social <span class="text-primary">Media</span>
            </h1>
            <p class="text-slate-500 max-w-xl mx-auto text-base md:text-lg">
                Punya pertanyaan, saran, atau ingin berkolaborasi? Jangan ragu untuk menghubungi kami melalui platform di bawah ini.
            </p>
            <div class="w-16 h-1.5 bg-primary mx-auto mt-6 rounded-full"></div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                ...
                <a href="mailto:ronekimedia@gmail.com" class="group bg-white p-8 rounded-[2rem] border-2 border-slate-50 shadow-xl shadow-slate-200/50 hover:border-primary/30 hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-2 text-center flex flex-col items-center">
                    ...
                    <p class="text-sm text-slate-500 mb-4">Untuk kerjasama & pertanyaan umum</p>
                    <span class="text-primary font-bold text-sm group-hover:underline break-all">
                        @nekonime.idn
                    </span>
                </a>
    ...
    <section class="pb-20 pt-8">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 overflow-hidden flex flex-col lg:flex-row">
                
                <div class="w-full lg:w-1/3 p-8 md:p-12 flex flex-col justify-center bg-white">
                    <h3 class="text-2xl font-extrabold text-slate-900 mb-6 flex items-center gap-3">
                        <i class="fa-solid fa-map-location-dot text-primary"></i>
                        Malaka UBP Karawang
                    </h3>
                    <p class="text-slate-600 leading-relaxed mb-6 font-medium">
                        Kunjungi kami untuk berdiskusi langsung atau sekadar bersilaturahmi.
                    </p>
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            <i class="fa-solid fa-building text-primary mt-1"></i>
                            <div>
                                <h5 class="font-bold text-slate-900">Universitas Buana Perjuangan</h5>
                                <p class="text-sm text-slate-500">Jl. HS.Ronggo Waluyo, Puseurjaya, Telukjambe Timur, Karawang, Jawa Barat 41361</p>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="w-full lg:w-2/3 h-64 lg:h-auto bg-slate-100">
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7931.0887965153215!2d107.301977!3d-6.323412!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69762d4c316603%3A0x50a8005dfd52a897!2sUniversitas%20Buana%20Perjuangan%20Karawang!5e0!3m2!1sid!2sid!4v1770906153586!5m2!1sid!2sid" 
                        width="100%" 
                        height="100%" 
                        style="border:0;" 
                        allowfullscreen="" 
